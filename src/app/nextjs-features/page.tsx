...
const categories = ['全部', '基础特性', '数据管理', '性能优化', 'API 开发', 'SEO 优化', '样式设计', '状态管理', '表单处理', '国际化', '测试', '安全性'];
            ...
            {filteredFeatures.map(feature => (
              ...
              >
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <span className="text-sm text-gray-500 mb-2 block">分类: {feature.category}</span>
                  </div>

                  <div className="space-y-2">
                    <h4 className="text-sm font-medium text-gray-700">包含示例:</h4>
