					...
					<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
							<div className="text-center p-4 bg-blue-50 rounded-lg">
								...
								<h3 className="font-semibold text-blue-900 mb-2">受控组件</h3>
								<p className="text-sm text-blue-700">React 原生</p>
							...
							<div className="text-center p-4 bg-cyan-50 rounded-lg">
								...
								<h3 className="font-semibold text-cyan-900 mb-2">Zod</h3>
								<p className="text-sm text-cyan-700">类型安全</p>
							...
							<div className="text-center p-4 bg-orange-50 rounded-lg">
								...
								<h3 className="font-semibold text-orange-900 mb-2">文件上传</h3>
								<p className="text-sm text-orange-700">多媒体</p>
							...
							<div className="text-center p-4 bg-red-50 rounded-lg">
								...
								<h3 className="font-semibold text-red-900 mb-2">多步骤</h3>
								<p className="text-sm text-red-700">复杂表单</p>
							...
							<div className="text-center p-4 bg-green-50 rounded-lg">
								...
								<h3 className="font-semibold text-green-900 mb-2">非受控</h3>
								<p className="text-sm text-green-700">简单表单</p>
									...
									<div className="p-6 border-b border-gray-200">
										...
										<div className="grid grid-cols-3 gap-4 text-sm">
											...
											<div className="text-center p-2 bg-gray-50 rounded">
												...
												<div className="text-gray-600">
													{selectedExample.performance.userExperience}
												</div>
											</div>
										</div>
									</div>
