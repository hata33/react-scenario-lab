...
import { ArrowLeft, Zap, Image as ImageIcon, Type, Code, Monitor, CheckCircle } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">核心 Web Vitals</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                ...
                <h3 className="font-semibold text-purple-900 mb-1">Bundle Size</h3>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mb-2">
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getCategoryColor(example.category)}`}>
                            {example.category}
                          </span>
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(example.difficulty)}`}>
                            {example.difficulty}
                          </span>
                          <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(example.status)}`}>
              ...
              {selectedExample ? (
                <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                  <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getCategoryColor(selectedExample.category)}`}>
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-4">
                      <div className="text-center p-2 bg-blue-50 rounded">
                        <div className="text-xs text-blue-600 font-medium">LCP</div>
                        <div className="text-sm font-bold text-blue-900">{selectedExample.metrics.lcp}</div>
                      </div>
                      <div className="text-center p-2 bg-green-50 rounded">
                        <div className="text-xs text-green-600 font-medium">FID</div>
                        <div className="text-sm font-bold text-green-900">{selectedExample.metrics.fid}</div>
                      </div>
                      <div className="text-center p-2 bg-yellow-50 rounded">
                        <div className="text-xs text-yellow-600 font-medium">CLS</div>
                        <div className="text-sm font-bold text-yellow-900">{selectedExample.metrics.cls}</div>
                      </div>
                      <div className="text-center p-2 bg-purple-50 rounded">
                        <div className="text-xs text-purple-600 font-medium">Bundle</div>
                        <div className="text-sm font-bold text-purple-900">{selectedExample.metrics.bundle}</div>
                      </div>
                    </div>
                    ...
                    {selectedExample.demo && (
                      <div className="mb-4">
                        <h4 className="text-sm font-medium text-gray-900 mb-2">演示</h4>
                        {selectedExample.demo}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6">
                      <h5 className="font-medium text-gray-900 mb-2">主要优势</h5>
