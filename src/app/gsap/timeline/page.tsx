  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ marginTop: 16, display: "flex", gap: 8 }}>
        <button onClick={() => tlRef.current?.play()} className="btn">Play</button>
        <button onClick={() => tlRef.current?.pause()} className="btn">Pause</button>
        <button onClick={() => tlRef.current?.reverse()} className="btn">Reverse</button>
        <button onClick={() => tlRef.current?.seek(0)} className="btn">Seek 0</button>
        <button onClick={() => tlRef.current?.restart()} className="btn">Restart</button>
      </div>
