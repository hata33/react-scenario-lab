	...
	return (
		<Layout>
			<div style={{ padding: "40px", textAlign: "center" }}>
				<h1 style={{ fontSize: "32px", fontWeight: "bold", marginBottom: "20px" }}>🎯 GSAP ScrollTrigger 组件测试</h1>
				<p style={{ fontSize: "18px", color: "#666", marginBottom: "40px" }}>测试所有组件是否正常加载和工作</p>
