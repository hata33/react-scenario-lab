...
export default function Page() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ position: "relative", height: 60, background: "#f7f7f7", borderRadius: 8, padding: 10 }}>
        <div ref={ballRef} style={{ width: 36, height: 36, borderRadius: 18, background: "#3b82f6" }} />
      </div>
    </div>
  );
}