...
const coreTechDetails = [
	{
		...
		description: "HTML（HyperText Markup Language）超文本标记语言，是构建网页的基础。它定义了网页的内容结构和语义，是所有网页技术的基石。",
		keyFeatures: [
			{
				title: "核心概念",
				items: [
...
<body>
  ...
  <footer>
    <p>&copy; 2026 版权信息</p>
			...
			explanation: "使用 HTML5 语义化标签构建页面结构，header、nav、main、article、aside、footer 等标签使页面结构清晰，有利于 SEO 和可访问性。"
		}
	},
	{
		id: "css",
		...
		description: "CSS（Cascading Style Sheets）层叠样式表，用于描述 HTML 文档的呈现方式。它控制网页的布局、颜色、字体、动画等所有视觉效果。",
		keyFeatures: [
			{
				title: "核心概念",
				items: [
...
@media (max-width: 768px) {
  .container {
    flex-direction: column;
			...
			explanation: "使用 Flexbox 实现响应式布局，justify-content 和 align-items 控制对齐，flex-wrap 实现自动换行，配合媒体查询实现移动端适配。"
		}
	},
	{
		id: "javascript",
		...
		description: "JavaScript 是一种轻量级的编程语言，最初为网页交互而设计，现在已成为最流行的编程语言之一，可用于前端、后端、移动端等各个领域。",
		keyFeatures: [
			{
				title: "核心概念",
				items: [
...
const platforms = [
	...
	},
	{
		...
		techStack: ["iOS: Swift/Objective-C", "Android: Kotlin/Java", "React Native/Flutter", "原生UI组件", "App Store/应用商店发布"],
...
function HeroBlock() {
	return (
		<section className="relative flex flex-col items-center justify-center min-h-[60vh] px-4 py-16 text-white bg-gradient-to-br from-indigo-600 to-purple-700">
			<div className="relative z-10 max-w-4xl mx-auto text-center">
				<h1 className="text-5xl md:text-7xl font-bold mb-6">
					{heroContent.title}
				</h1>
				<h2 className="text-2xl md:text-3xl mb-4 text-white/80">
		...
		<section className="py-16 bg-gradient-to-b from-blue-50 to-white dark:from-slate-900 dark:to-slate-800">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full text-sm font-semibold mb-4">
						第一优先级 · 核心概念
					</span>
				...
				<div className="grid md:grid-cols-3 gap-6 mb-12">
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-2 border-orange-200 dark:border-orange-900 hover:border-orange-400 dark:hover:border-orange-700 transition-all">
						<div className="text-5xl mb-4">📄</div>
						<h3 className="text-2xl font-bold mb-2 text-orange-600 dark:text-orange-400">HTML</h3>
						<p className="text-sm text-slate-500 dark:text-slate-400 mb-3">超文本标记语言</p>
					...
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-2 border-blue-200 dark:border-blue-900 hover:border-blue-400 dark:hover:border-blue-700 transition-all">
						<div className="text-5xl mb-4">🎨</div>
						<h3 className="text-2xl font-bold mb-2 text-blue-600 dark:text-blue-400">CSS</h3>
						<p className="text-sm text-slate-500 dark:text-slate-400 mb-3">层叠样式表</p>
						<p className="text-slate-700 dark:text-slate-300">
					...
					<div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-2 border-yellow-200 dark:border-yellow-900 hover:border-yellow-400 dark:hover:border-yellow-700 transition-all">
						<div className="text-5xl mb-4">⚡</div>
						<h3 className="text-2xl font-bold mb-2 text-yellow-600 dark:text-yellow-400">JavaScript</h3>
						<p className="text-sm text-slate-500 dark:text-slate-400 mb-3">脚本语言</p>
						<p className="text-slate-700 dark:text-slate-300">
						...
						<table className="w-full">
							<thead>
								<tr className="border-b-2 border-slate-200 dark:border-slate-700">
									<th className="py-3 px-4 text-left text-slate-700 dark:text-slate-300">维度</th>
									<th className="py-3 px-4 text-left text-blue-600 dark:text-blue-400">前端（Frontend）</th>
									<th className="py-3 px-4 text-left text-green-600 dark:text-green-400">后端（Backend）</th>
								</tr>
							</thead>
							<tbody>
								<tr className="border-b border-slate-100 dark:border-slate-700">
									<td className="py-3 px-4 font-medium text-slate-700 dark:text-slate-300">运行环境</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">浏览器</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">服务器</td>
								</tr>
								<tr className="border-b border-slate-100 dark:border-slate-700">
									<td className="py-3 px-4 font-medium text-slate-700 dark:text-slate-300">用户可见</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">是（直接看到和操作）</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">否（服务器端运行）</td>
								</tr>
								<tr className="border-b border-slate-100 dark:border-slate-700">
									<td className="py-3 px-4 font-medium text-slate-700 dark:text-slate-300">主要职责</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">用户界面、交互体验</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">业务逻辑、数据处理</td>
								</tr>
								<tr>
									<td className="py-3 px-4 font-medium text-slate-700 dark:text-slate-300">关注重点</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">用户体验、视觉呈现</td>
									<td className="py-3 px-4 text-slate-600 dark:text-slate-400">数据安全、性能稳定</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-8">
					<h3 className="text-2xl font-bold mb-6 text-center text-slate-900 dark:text-slate-100">
						前端技术发展历程
					</h3>
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
						{[
							{ name: "史前时期", period: "1940s - 1980s", desc: "计算机图形界面诞生，超文本概念出现", color: "purple" },
							{ name: "静态网页时代", period: "1990 - 1995", desc: "HTML诞生，Web开始起步", color: "blue" },
							{ name: "动态交互萌芽", period: "1995 - 2005", desc: "JavaScript和CSS出现，初步实现动态效果", color: "green" },
							...
							<div key={index} className="era-item">
								<div className="flex items-center gap-2 mb-2">
									<div className={`w-3 h-3 rounded-full bg-${era.color}-500`}></div>
									<h4 className="font-bold text-slate-900 dark:text-slate-100">{era.name}</h4>
								</div>
								<p className="text-sm text-slate-600 dark:text-slate-400 mb-1">{era.period}</p>
								<p className="text-xs text-slate-500 dark:text-slate-500">{era.desc}</p>
							</div>
						))}
					</div>
				</div>
...
function FrontendWorkBlock() {
	return (
		<section className="py-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-emerald-100 dark:bg-emerald-900 text-emerald-700 dark:text-emerald-300 rounded-full text-sm font-semibold mb-4">
						职业认知
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端开发者做什么？
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
					{[
						{ title: "页面开发", icon: "🎨", color: "blue", items: ["将UI设计稿还原为HTML/CSS代码", "实现响应式布局，适配多种设备", "保证视觉还原度和像素级精确", "实现复杂动画和过渡效果"] },
						{ title: "交互实现", icon: "⚡", color: "green", items: ["实现用户操作响应和反馈", "处理表单验证和数据提交", "实现复杂的状态管理和逻辑", "与后端API对接和数据交互"] },
						{ title: "性能优化", icon: "🚀", color: "purple", items: ["优化页面加载速度和首屏渲染", "减少HTTP请求和资源大小", "实现懒加载和代码分割", "优化渲染性能和用户体验"] },
						{ title: "兼容性处理", icon: "🔧", color: "orange", items: ["处理不同浏览器的兼容问题", "适配各种屏幕尺寸和分辨率", "使用Polyfill解决API不支持", "渐进增强和优雅降级策略"] },
						{ title: "工程化建设", icon: "🛠️", color: "cyan", items: ["搭建和维护前端构建流程", "实现组件库和设计系统", "编写单元测试和集成测试", "建立代码规范和最佳实践"] },
						{ title: "多端开发", icon: "📱", color: "pink", items: ["开发PC端和移动端网站", "开发H5页面和小程序", "使用跨平台技术（React Native等）", "适配不同平台的特性差异"] }
					].map((job, index) => (
						<div key={index} className={`bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border-l-4 border-${job.color}-500`}>
							<div className="flex items-center gap-3 mb-4">
								<div className={`w-12 h-12 bg-${job.color}-100 dark:bg-${job.color}-900 rounded-lg flex items-center justify-center`}>
									<span className="text-2xl">{job.icon}</span>
								</div>
								<h4 className="text-xl font-bold text-slate-900 dark:text-slate-100">{job.title}</h4>
							</div>
				...
				<div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-8">
					...
					<div className="grid md:grid-cols-4 gap-4">
						{[
							...
							<div key={index} className="bg-white dark:bg-slate-800 rounded-lg p-5 text-center">
								<div className={`w-16 h-16 bg-${level.color}-100 dark:bg-${level.color}-900 rounded-full flex items-center justify-center mx-auto mb-3`}>
									<span className="text-3xl">{level.icon}</span>
								</div>
								<h4 className="font-bold text-lg mb-2 text-slate-900 dark:text-slate-100">{level.title}</h4>
...
function FrontendResponsibilitiesBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 rounded-full text-sm font-semibold mb-4">
						工作内容
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端开发者的一天
				...
				<div className="mb-16">
					<h3 className="text-2xl font-bold mb-8 text-center text-slate-900 dark:text-slate-100">
						典型工作流程
					</h3>
					<div className="relative">
						...
						<div className="space-y-6 md:ml-16">
							{[
								{ icon: "📋", title: "需求评审", desc: "参与产品需求评审，理解业务目标，评估技术可行性", color: "blue", tags: ["理解需求", "技术评估", "工期预估"] },
								{ icon: "🎨", title: "设计对接", desc: "与设计师确认交互细节，讨论视觉实现方案，确保可行性", color: "purple", tags: ["视觉评审", "交互确认", "素材获取"] },
								{ icon: "💻", title: "开发实现", desc: "编写代码实现功能，进行自测，修复bug，优化性能", color: "green", tags: ["UI开发", "逻辑实现", "接口联调", "性能优化"] },
								{ icon: "🚀", title: "测试上线", desc: "配合测试团队修复bug，进行代码评审，最终部署上线", color: "orange", tags: ["自测", "Bug修复", "代码评审", "部署上线"] }
							].map((step, index) => (
								<div key={index} className="flex gap-4 items-start">
									<div className={`w-16 h-16 bg-${step.color}-100 dark:bg-${step.color}-900 rounded-full flex items-center justify-center text-2xl shrink-0 z-10`}>
										{step.icon}
									</div>
									<div className="flex-1 bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg">
										<h4 className="text-xl font-bold mb-2 text-slate-900 dark:text-slate-100">{step.title}</h4>
										<p className="text-slate-600 dark:text-slate-400 mb-3">{step.desc}</p>
										<div className="flex flex-wrap gap-2">
											{step.tags.map((tag, i) => (
												<span key={i} className={`px-3 py-1 bg-${step.color}-100 dark:bg-${step.color}-900 text-${step.color}-700 dark:text-${step.color}-300 rounded-full text-xs`}>
													{tag}
												</span>
											))}
										</div>
					...
					<div className="max-w-5xl mx-auto">
						<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
							<div className="flex items-start gap-4 mb-6">
								<div className={`w-16 h-16 rounded-xl flex items-center justify-center text-3xl bg-${current.color}-100 dark:bg-${current.color}-900`}>
									{current.icon}
								</div>
								<div className="flex-1">
									<div className="flex items-center gap-3 mb-2">
										<h4 className="text-2xl font-bold text-slate-900 dark:text-slate-100">{current.title}</h4>
										<span className={`px-3 py-1 rounded-full text-xs font-semibold bg-${current.color}-100 text-${current.color}-700 dark:bg-${current.color}-900 dark:text-${current.color}-300`}>
											{current.category}
										</span>
									</div>
							...
							<div className="mb-6">
								<h5 className="font-bold mb-3 text-slate-900 dark:text-slate-100 flex items-center gap-2">
									<span>📝</span>
									<span>具体任务</span>
								</h5>
								<div className="grid md:grid-cols-2 gap-3">
									{current.tasks.map((task, index) => (
										<div key={index} className="flex items-start gap-2 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg">
								...
								<div>
									...
									<div className="flex flex-wrap gap-2">
										{current.skills.map((skill, index) => (
											<span key={index} className={`px-3 py-1 text-sm rounded-full bg-${current.color}-100 text-${current.color}-700 dark:bg-${current.color}-900 dark:text-${current.color}-300`}>
												{skill}
											</span>
										))}
									</div>
								...
								<div>
									...
									<div className="flex flex-wrap gap-2">
										{current.tools.map((tool, index) => (
											<span key={index} className="px-3 py-1 text-sm rounded-full bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300">
												{tool}
											</span>
										))}
									</div>
...
function FrontendPlatformsBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-white to-slate-50 dark:from-slate-800 dark:to-slate-900">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-violet-100 dark:bg-violet-900 text-violet-700 dark:text-violet-300 rounded-full text-sm font-semibold mb-4">
						技术载体
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端开发的四大载体
						...
						<button
							...
							className={cn(
								...
								activePlatform === platform.id
									? `bg-${platform.color}-500 text-white shadow-lg scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
				...
				<div className="max-w-6xl mx-auto">
					<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-6">
						<div className="flex items-center gap-4 mb-6">
							<div className={`w-20 h-20 rounded-xl flex items-center justify-center text-4xl bg-${current.color}-100 dark:bg-${current.color}-900`}>
								{current.icon}
							</div>
							<div className="flex-1">
								<h3 className="text-3xl font-bold mb-2 text-slate-900 dark:text-slate-100">
									{current.name}
								</h3>
						...
						<div className="mb-6">
							<h4 className="text-lg font-bold mb-3 text-slate-900 dark:text-slate-100 flex items-center gap-2">
								<span>✨</span>
								<span>核心特性</span>
							</h4>
							<div className="grid md:grid-cols-2 gap-3">
					...
					<div className="grid md:grid-cols-2 gap-6">
						<div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
							<h4 className="text-lg font-bold mb-4 text-slate-900 dark:text-slate-100 flex items-center gap-2">
								<span>🛠️</span>
								<span>技术栈</span>
							</h4>
							<div className="flex flex-wrap gap-2">
						...
						<div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6">
							<h4 className="text-lg font-bold mb-4 text-green-700 dark:text-green-400 flex items-center gap-2">
								<span>✅</span>
								<span>核心优势</span>
							</h4>
						...
						<div className="bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-xl p-6">
							<h4 className="text-lg font-bold mb-4 text-red-700 dark:text-red-400 flex items-center gap-2">
								<span>⚠️</span>
								<span>注意事项</span>
							</h4>
							<ul className="space-y-2">
...
function CoreTechBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300 rounded-full text-sm font-semibold mb-4">
						核心技术
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端三大核心技术
				...
				<div className="flex justify-center gap-4 mb-12">
					{coreTechDetails.map((tech) => (
						<button
							...
							className={cn(
								"px-8 py-4 rounded-xl font-semibold transition-all flex flex-col items-center gap-2",
								activeTech === tech.id
									? `bg-${tech.color === "yellow" ? "yellow" : tech.color}-500 text-white shadow-xl scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
				...
				<div className="max-w-6xl mx-auto">
					<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-6">
						<div className="flex items-start gap-6">
							<div className={`w-24 h-24 rounded-2xl flex items-center justify-center text-5xl bg-${currentTech.color === "yellow" ? "yellow" : currentTech.color}-100 dark:bg-${currentTech.color === "yellow" ? "yellow" : currentTech.color}-900`}>
								{currentTech.icon}
							</div>
							<div className="flex-1">
								<h3 className="text-3xl font-bold mb-2 text-slate-900 dark:text-slate-100">
								...
								<div className="flex flex-wrap gap-4 text-sm">
									<div className="flex items-center gap-2">
										...
										<span className="text-slate-700 dark:text-slate-300">
											出生于 {currentTech.birthYear} 年
										</span>
									</div>
									<div className="flex items-center gap-2">
										<span className="text-slate-500">👨‍💻</span>
										<span className="text-slate-700 dark:text-slate-300">
											创造者 {currentTech.creator}
										</span>
									</div>
									<div className="flex items-center gap-2">
										<span className="text-slate-500">📅</span>
										<span className="text-slate-700 dark:text-slate-300">
											距今 {2026 - currentTech.birthYear} 年
										</span>
									</div>
								</div>
							</div>
					...
					<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
						{activeTab === "overview" && (
							<div className="space-y-8">
								{currentTech.keyFeatures.map((featureGroup, index) => (
									<div key={index}>
										<h4 className="text-xl font-bold mb-4 text-slate-900 dark:text-slate-100 flex items-center gap-2">
											<span>{index === 0 ? "🔑" : "✨"}</span>
											...
											{featureGroup.items.map((item, itemIndex) => (
												...
												>
													<div className="flex items-start gap-2">
														<span className={`${
															currentTech.color === "orange" ? "text-orange-500" :
															currentTech.color === "blue" ? "text-blue-500" :
															"text-yellow-500"
														}`}>✓</span>
										...
										<div key={index} className="flex gap-4 mb-6">
											<div className="flex flex-col items-center">
												<div className={`w-12 h-12 rounded-full flex items-center justify-center text-lg font-bold ${
													currentTech.color === "orange" ? "bg-orange-100 text-orange-600 dark:bg-orange-900 dark:text-orange-400" :
													currentTech.color === "blue" ? "bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400" :
													"bg-yellow-100 text-yellow-600 dark:bg-yellow-900 dark:text-yellow-400"
												}`}>
													{event.year}
												</div>
												{index < currentTech.history.length - 1 && (
													<div className="w-0.5 h-16 bg-slate-300 dark:bg-slate-700"></div>
												)}
											</div>
						...
						{activeTab === "code" && (
							<div className="space-y-6">
								<div>
									<h4 className="text-xl font-bold mb-4 text-slate-900 dark:text-slate-100">
								...
								<div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
									<h5 className="font-bold mb-2 text-slate-900 dark:text-slate-100">💡 代码说明</h5>
									<p className="text-slate-700 dark:text-slate-300 text-sm">
										{currentTech.codeExample.explanation}
									</p>
								</div>
							</div>
						)}
...
function BrowserHistoryBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-white to-slate-50 dark:from-slate-800 dark:to-slate-900">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300 rounded-full text-sm font-semibold mb-4">
						浏览器历史
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						浏览器发展史
					...
					{browserEras.map((era) => (
						<button
							...
							className={cn(
								...
								activeEra === era.id
									? `bg-${era.color === "purple" ? "purple" : era.color === "red" ? "red" : era.color === "gray" ? "gray" : era.color === "orange" ? "orange" : "blue"}-500 text-white shadow-lg scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
					...
					return (
						<>
							<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
								<div className="flex items-center gap-4 mb-6">
									<div className={`w-16 h-16 rounded-xl flex items-center justify-center text-3xl bg-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-100 dark:bg-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-900`}>
										📜
									</div>
									<div className="flex-1">
										<h3 className="text-2xl font-bold mb-1 text-slate-900 dark:text-slate-100">
											{currentEra.name}
										</h3>
										<p className={`text-sm font-semibold text-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-600 dark:text-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-400`}>
											{currentEra.period}
										</p>
									</div>
								</div>
							...
							<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
								{currentEra.browsers.map((browser, index) => (
									<div
										key={index}
										className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 border-t-4"
										style={{ borderColor: currentEra.color === "purple" ? "#a855f7" : currentEra.color === "red" ? "#ef4444" : currentEra.color === "gray" ? "#6b7280" : currentEra.color === "orange" ? "#f97316" : "#3b82f6" }}
									>
										<div className="flex items-center gap-3 mb-4">
										...
										{browser.marketPeak && (
											<div className={`text-center p-2 rounded-lg bg-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-50 dark:bg-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-900/20`}>
												<div className="text-xs text-slate-500 dark:text-slate-400">巅峰市场份额</div>
												<div className={`text-2xl font-bold text-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-600 dark:text-${currentEra.color === "purple" ? "purple" : currentEra.color === "red" ? "red" : currentEra.color === "gray" ? "gray" : currentEra.color === "orange" ? "orange" : "blue"}-400`}>
													{browser.marketPeak.share}
												</div>
												<div className="text-xs text-slate-500 dark:text-slate-400">
													{browser.marketPeak.year} 年
												</div>
											</div>
										)}
									</div>
					...
					{frameworkEras.map((era) => (
						<button
							...
							className={cn(
								"px-5 py-3 rounded-lg font-medium transition-all",
								activeEra === era.id
									? `bg-${era.color === "blue" ? "blue" : era.color === "green" ? "green" : era.color === "red" ? "red" : era.color === "orange" ? "orange" : "purple"}-500 text-white shadow-lg scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
							<div className="text-xs opacity-70">{era.period}</div>
							...
							<div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 mb-8">
								<div className="flex items-center gap-4 mb-6">
									...
									<div className="flex-1">
										...
										<p className={`text-sm font-semibold text-${currentEra.color === "blue" ? "blue" : currentEra.color === "green" ? "green" : currentEra.color === "red" ? "red" : currentEra.color === "orange" ? "orange" : "purple"}-600 dark:text-${currentEra.color === "blue" ? "blue" : currentEra.color === "green" ? "green" : currentEra.color === "red" ? "red" : currentEra.color === "orange" ? "orange" : "purple"}-400`}>
											{currentEra.period}
										</p>
									</div>
								</div>
...
function FrontendToolsBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-white to-slate-50 dark:from-slate-800 dark:to-slate-900">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-cyan-100 dark:bg-cyan-900 text-cyan-700 dark:text-cyan-300 rounded-full text-sm font-semibold mb-4">
						工程化
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端工具链
				...
				<div className="flex flex-wrap justify-center gap-3 mb-12">
					{toolCategories.map((category) => (
						<button
							...
							className={cn(
								"px-5 py-3 rounded-lg font-medium transition-all flex items-center gap-2",
								activeCategory === category.id
									? `bg-${category.color === "blue" ? "blue" : category.color === "green" ? "green" : category.color === "purple" ? "purple" : category.color === "orange" ? "orange" : "pink"}-500 text-white shadow-lg scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
						...
						<button
							...
							className={cn(
								...
								activeLevel === level.id
									? `bg-${level.color === "green" ? "green" : level.color === "blue" ? "blue" : level.color === "purple" ? "purple" : "orange"}-500 text-white shadow-xl scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
							<div className="text-xs opacity-70 mb-1">{level.period}</div>
...
function PerformanceBlock() {
	...
	return (
		<section className="py-16 bg-gradient-to-b from-white to-slate-50 dark:from-slate-800 dark:to-slate-900">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					<span className="inline-block px-4 py-1 bg-rose-100 dark:bg-rose-900 text-rose-700 dark:text-rose-300 rounded-full text-sm font-semibold mb-4">
						性能优化
					</span>
					<h2 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900 dark:text-slate-100">
						前端性能优化
					...
					{performanceCategories.map((category) => (
						<button
							...
							className={cn(
								"px-5 py-3 rounded-lg font-medium transition-all flex items-center gap-2",
								activeCategory === category.id
									? `bg-${category.color === "blue" ? "blue" : category.color === "green" ? "green" : category.color === "purple" ? "purple" : "orange"}-500 text-white shadow-lg scale-105`
									: "bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700"
							)}
						>
							<span className="text-xl">{category.icon}</span>
				...
				<div className="mt-16 bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8">
					<h3 className="text-2xl font-bold mb-8 text-center text-slate-900 dark:text-slate-100">
					...
					<div className="grid md:grid-cols-3 gap-6">
						<div className="text-center p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl">
							...
							<h4 className="font-bold text-lg mb-2 text-slate-900 dark:text-slate-100">LCP</h4>
						...
						<div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl">
							...
							<h4 className="font-bold text-lg mb-2 text-slate-900 dark:text-slate-100">FID</h4>
							<p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
						...
						<div className="text-center p-6 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 rounded-xl">
							<div className="text-4xl mb-3">📐</div>
							<h4 className="font-bold text-lg mb-2 text-slate-900 dark:text-slate-100">CLS</h4>
							<p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
