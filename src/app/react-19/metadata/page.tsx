					...
					<div className="grid gap-6 md:grid-cols-3">
						<div className="rounded-lg border border-blue-200 bg-white p-4 dark:border-blue-700 dark:bg-gray-800">
							...
							<p className="text-gray-700 dark:text-gray-300">
								文档元数据标签允许在 React 组件中直接使用 HTML 头部标签，如 title、meta、link
								等，这些标签会自动提升到文档的 head 部分。
							</p>
						</div>
						<div className="rounded-lg border border-blue-200 bg-white p-4 dark:border-blue-700 dark:bg-gray-800">
						...
						<div>
							...
							<ul className="space-y-2 text-gray-700 dark:text-gray-300">
								<li className="flex items-start">
									...
									<span>
										<strong>SEO 管理复杂</strong>：需要手动操作 DOM 或使用第三方库
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-red-500">•</span>
									<span>
										<strong>社交媒体分享差</strong>：缺乏 Open Graph 和 Twitter Card 支持
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-red-500">•</span>
									<span>
										<strong>代码分散</strong>：元数据定义与组件逻辑分离
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-red-500">•</span>
									<span>
										<strong>维护困难</strong>：动态内容更新时需要手动同步元数据
									</span>
								</li>
							</ul>
						</div>
						<div>
							...
							<ul className="space-y-2 text-gray-700 dark:text-gray-300">
								<li className="flex items-start">
									...
									<span>
										<strong>组件内定义</strong>：直接在组件中声明元数据
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-green-500">✓</span>
									<span>
										<strong>自动提升</strong>：标签自动提升到 head 中
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-green-500">✓</span>
									<span>
										<strong>动态更新</strong>：数据变化时自动更新元数据
									</span>
								</li>
								<li className="flex items-start">
									<span className="mt-1 mr-2 text-green-500">✓</span>
									<span>
										<strong>完整支持</strong>：支持所有标准 HTML 元数据标签
									</span>
								</li>
							</ul>
						</div>
...
function DynamicSEODemo() {
	...
	return (
		<div>
			<h3 className="mb-4 font-bold text-2xl text-gray-900 dark:text-white">🔍 动态 SEO 演示</h3>
			...
			<div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
				<h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">动态 SEO 的优势：</h4>
...
function SocialSharingDemo() {
	...
	return (
		<div>
			<h3 className="mb-4 font-bold text-2xl text-gray-900 dark:text-white">📱 社交媒体分享演示</h3>
			<p className="mb-6 text-gray-600 dark:text-gray-300">优化 Open Graph 和 Twitter Card，提升社交媒体分享效果。</p>
...
<meta name="twitter:card" content="summary_large_image" />`}</code>
			...
			<div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
				<h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">社交媒体优化的优势：</h4>
				<ul className="space-y-1 text-blue-800 text-sm dark:text-blue-200">
...
function ProductMetadataDemo() {
	...
	return (
		<div>
			<h3 className="mb-4 font-bold text-2xl text-gray-900 dark:text-white">🛒 电商产品元数据演示</h3>
			<p className="mb-6 text-gray-600 dark:text-gray-300">电商产品页面的完整 SEO 和结构化数据优化。</p>
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    "availability": "${productData.availability === "InStock" ? "https://schema.org/InStock" : "https://schema.org/OutOfStock"}"
			...
			<div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
				<h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">电商元数据的优势：</h4>
				<ul className="space-y-1 text-blue-800 text-sm dark:text-blue-200">
...
function BlogSEODemo() {
	...
	return (
		<div>
			<h3 className="mb-4 font-bold text-2xl text-gray-900 dark:text-white">📝 博客文章 SEO 演示</h3>
			<p className="mb-6 text-gray-600 dark:text-gray-300">
					...
					<div className="rounded-lg border bg-white p-6 dark:bg-gray-800">
						<article>
							...
							<footer className="mt-8 border-gray-200 border-t pt-6 dark:border-gray-700">
								<div className="flex items-center justify-between">
									<div className="flex items-center gap-4">
										<span className="text-gray-600 text-sm dark:text-gray-400">作者: {blogPost.author}</span>
...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    ...
    "@id": "${blogPost.canonicalUrl}"
			...
			<div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
				<h4 className="mb-2 font-semibold text-blue-900 dark:text-blue-100">博客 SEO 的优势：</h4>
				<ul className="space-y-1 text-blue-800 text-sm dark:text-blue-200">
