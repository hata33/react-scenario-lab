...
// 传统 forwardRef 组件
const TraditionalInput = React.forwardRef<
	HTMLInputElement,
	{
		placeholder: string;
		value: string;
...
>(({ placeholder, value, onChange, focused }, forwardedRef) => {
	return (
		...
		<div className="space-y-2">
			...
			<input
				...
				className={`w-full rounded-md border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 ${
					focused ? "border-green-500 ring-2 ring-green-500" : "border-gray-300"
				}`}
			/>
			...
			<div className="rounded-md bg-gray-50 p-4">
				...
				<div className="space-y-4">
					<TraditionalInput
						...
						focused={focusedInput === "traditional"}
					/>
					<button
