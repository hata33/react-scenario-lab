...
export default async function ThoughtsPage() {
	...
	return (
		<Layout>
				...
				<div className="container mx-auto px-4">
					<div className="mx-auto grid max-w-2xl gap-4">
						...
						<Link
							...
							className="border border-blue-600 bg-blue-600 p-4 text-white"
						>
							<div className="flex items-center justify-between">
								<div className="flex items-center gap-3">
									<span className="text-2xl">⚡</span>
									<div>
										...
										<p className="text-white/80 text-sm">工程化实践</p>
									</div>
								</div>
								<span>→</span>
							</div>
			...
			{/* 技术时代 */}
			<section id="eras" className="border-b border-slate-200 bg-slate-50 py-20 dark:border-slate-800 dark:bg-slate-900">
				<div className="container mx-auto px-4">
					<div className="mb-12 text-center">
						<div className="mb-4">
							<span className="font-semibold text-slate-500 text-sm dark:text-slate-400">完整历程</span>
						</div>
						<h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100">技术时代</h2>
						...
						{config.eras.map((era) => (
							...
							>
								<div className="mb-3 flex items-center gap-2">
									<div
										className="h-3 w-3"
										style={{ backgroundColor: era.theme.primaryColor }}
									/>
								...
								<div className="mt-4 flex items-center text-sm font-medium text-slate-900 dark:text-slate-100">
									查看详情
			...
			<section className="py-20">
				<div className="container mx-auto px-4">
					<div className="mb-12 text-center">
						<h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100">继续探索</h2>
						<div className="mx-auto mt-4 h-px w-20 bg-slate-300 dark:bg-slate-700" />
					</div>
					...
					<div className="grid gap-6 md:grid-cols-3">
						<Link
							href="/frontend/modern"
							className="border border-blue-600 bg-blue-600 p-6 text-white"
						>
