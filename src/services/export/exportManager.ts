...
import { ExportConfig, ExportFormat, ExportOptions, ExportProgress, ExportHistory } from '@/types/export';
...
export class ExportManager {
   ...
   * 导出图片
   */
  private async exportImage(element: HTMLElement, format: 'png' | 'jpg' | 'svg', options?: ExportOptions): Promise<Blob> {
    switch (format) {
      case 'png':
