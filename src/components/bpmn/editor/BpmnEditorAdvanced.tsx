...
export default function BpmnEditorAdvanced({
	xml = defaultBpmnXml,
	readonly = false,
	onLoad,
	onError,
...
}: BpmnEditorProps & { showPropertiesPanel?: boolean }) {
	...
	return (
		<div className={`bpmn-editor-advanced flex ${className}`} style={style}>
			{/* 主编辑器区域 */}
			...
			{showPropertiesPanel && !readonly && (
				<div className="w-80 bg-white border-l border-gray-200 p-4 overflow-y-auto">
					<h3 className="text-lg font-semibold text-gray-800 mb-4">属性面板</h3>
