...
export default function FirstVisitWelcome() {
	...
	return (
		<div className="-translate-x-1/2 fixed top-4 left-1/2 z-50 w-full max-w-sm transform rounded-lg border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-700 dark:bg-gray-800">
