...
const sampleData = [
  ...
  { id: 2, name: '李四', age: 30, email: 'lisi@example.com', department: '市场部', salary: 6000 },
  { id: 3, name: '王五', age: 28, email: 'wangwu@example.com', department: '财务部', salary: 7000 },
  { id: 4, name: '赵六', age: 35, email: 'zhaoliu@example.com', department: '人事部', salary: 6500 },
  { id: 5, name: '钱七', age: 26, email: 'qianqi@example.com', department: '技术部', salary: 8500 }
];
...
export function ExportDemoPage() {
  ...
  const columns = [
    ...
    { title: '姓名', key: 'name', render: (_: any, record: any) => record.name },
    { title: '年龄', key: 'age', render: (_: any, record: any) => record.age },
    { title: '邮箱', key: 'email', render: (_: any, record: any) => record.email },
    { title: '部门', key: 'department', render: (_: any, record: any) => record.department },
    { title: '薪资', key: 'salary', render: (_: any, record: any) => `¥${record.salary}` }
  ];
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">导出功能演示</h1>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-blue-800">导出功能演示</h3>
          ...
          {activeTab === 'table' && (
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">员工数据表格</h3>
          ...
          {activeTab === 'text' && (
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">示例文档</h3>
                <div
                  ref={contentRef}
          ...
          {activeTab === 'page' && (
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">页面内容截图</h3>
                <div
                  ref={contentRef}
                  className="p-6 bg-white border-2 border-dashed border-gray-300 rounded-lg"
                >
                  <h3 className="text-xl font-bold text-gray-900 mb-4">页面内容示例</h3>
                  <p className="text-gray-600 mb-6">这是一个可以被导出为图片的页面内容区域。</p>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-900 mb-2">统计信息1</h4>
                      <p className="text-blue-700">数据项：100</p>
                      <p className="text-blue-700">完成率：85%</p>
                    </div>
                    <div className="bg-green-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-green-900 mb-2">统计信息2</h4>
                      <p className="text-green-700">用户数：1,234</p>
                      <p className="text-green-700">增长率：12%</p>
                    </div>
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-yellow-900 mb-2">统计信息3</h4>
          ...
          {progress && (
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">导出进度</h3>
              <div className="space-y-3">
                ...
                {progress.fileSize && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-900">{(progress.fileSize / 1024).toFixed(2)} KB</span>
                  </div>
                )}
              </div>
            </div>
